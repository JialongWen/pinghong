...
<!-- saved from url=(0049)http://localhost:8080/company/showProductList.jsp -->
...
<TABLE cellSpacing=0 cellPadding=0 width=799 align=center border=0>
  ...
  <TR>
    <TD><IMG height=40 src="image/d_r3_c1.jpg" width=60><IMG 
      ...
      height=40 src="image/top_red.jpg" width=20 border=0><A 
      href="http://localhost:8080/company/showProductList.jsp"><IMG id=image1 
      height=40 src="image/d_r3_c7.jpg" width=94 border=0 
      name=image1></A><IMG height=40 src="image/top_red.jpg" 
      width=20 border=0><A 
      href="http://localhost:8080/company/showNewsList.jsp"><IMG height=40 
      src="image/d_r3_c8.jpg" width=93 border=0></A><IMG 
      height=40 src="image/top_red.jpg" width=20 border=0><A 
      onclick=openChat() 
      href="http://localhost:8080/company/showProductList.jsp#"><IMG height=40 
      ...
      width=20 border=0><A href="http://localhost:8080/company/login.jsp"><IMG 
...
background="" border=0>
  ...
  <TR vAlign=bottom>
    <TD>&nbsp;&nbsp;<A class=nav 
      href="http://localhost:8080/company/index.jsp">首页</A><FONT class=nav> &gt; 
      </FONT><A class=nav 
      href="http://localhost:8080/company/showProductList.jsp">商品展示</A></TD></TR></TBODY></TABLE>
      ...
      <TABLE cellSpacing=0 cellPadding=4 width="100%" align=center border=0>
            ...
            border=0>
              ...
              <TR vAlign=top>
                <TD align=middle width=106 height=93><A 
                  href="http://localhost:8080/company/detailProduct.jsp?productID=10"><FONT 
                  color=#000000><IMG 
                      ...
                      <TD height=30>
                        ...
                        width="100%" bgColor=#cccccc border=0>
                          ...
                          <TR style="DISPLAY: block" bgColor=#99ccff>
                            ...
                            <TD bgColor=#ffffff><FONT 
                              color=#ff0033>5000.00</FONT>元</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD vAlign=top width="100%">
            <TABLE cellSpacing=2 cellPadding=0 width="100%" bgColor=#ffffff 
            border=0>
              ...
              <TR vAlign=top>
                <TD align=middle width=106 height=93><A 
                  href="http://localhost:8080/company/detailProduct.jsp?productID=7"><FONT 
                  color=#000000><IMG 
                  style="BORDER-LEFT-COLOR: #000000; BORDER-BOTTOM-COLOR: #000000; BORDER-TOP-COLOR: #000000; BORDER-RIGHT-COLOR: #000000" 
                  height=65 hspace=0 
                  src="image/d_r11_10_r1_c116.jpg" width=70 
                  align=center border=0></FONT></A></TD>
                <TD height=93>
                  <TABLE cellSpacing=1 cellPadding=4 width="100%" 
                  bgColor=#cccccc border=0>
                      ...
                      <TD height=30>
                        ...
                        width="100%" bgColor=#cccccc border=0>
                          ...
                          <TR bgColor=#99ccff>
                            ...
                            <TD align=middle width=80 bgColor=#f0f0f0>产品品牌</TD>
                            <TD bgColor=#ffffff><FONT 
                            color=#ff0033>柯达</FONT></TD></TR>
                          <TR style="DISPLAY: block" bgColor=#99ccff>
                            <TD align=middle width=80 bgColor=#f0f0f0>产品型号</TD>
                            <TD bgColor=#ffffff>柯达</TD>
                            <TD align=middle width=80 bgColor=#f0f0f0>产品价格</TD>
                            <TD bgColor=#ffffff><FONT 
                              color=#ff0033>8000.00</FONT>元</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD vAlign=top width="100%">
            <TABLE cellSpacing=2 cellPadding=0 width="100%" bgColor=#ffffff 
            border=0>
              ...
              <TR vAlign=top>
                <TD align=middle width=106 height=93><A 
                  href="http://localhost:8080/company/detailProduct.jsp?productID=6"><FONT 
                  color=#000000><IMG 
                  style="BORDER-LEFT-COLOR: #000000; BORDER-BOTTOM-COLOR: #000000; BORDER-TOP-COLOR: #000000; BORDER-RIGHT-COLOR: #000000" 
                  height=65 hspace=0 
                  src="image/d_r11_10_r1_c81.jpg" width=70 
                  align=center border=0></FONT></A></TD>
                <TD height=93>
                  <TABLE cellSpacing=1 cellPadding=4 width="100%" 
                  bgColor=#cccccc border=0>
        ...
        <TR>
          <TD vAlign=top width="100%">
            ...
            border=0>
              ...
              <TR vAlign=top>
                <TD align=middle width=106 height=93><A 
                  href="http://localhost:8080/company/detailProduct.jsp?productID=5"><FONT 
                  color=#000000><IMG 
                  style="BORDER-LEFT-COLOR: #000000; BORDER-BOTTOM-COLOR: #000000; BORDER-TOP-COLOR: #000000; BORDER-RIGHT-COLOR: #000000" 
                  height=65 hspace=0 
                  src="image/d_r11_10_r1_c2.jpg" width=70 
                  align=center border=0></FONT></A></TD>
                <TD height=93>
                  <TABLE cellSpacing=1 cellPadding=4 width="100%" 
                  bgColor=#cccccc border=0>
        ...
        <TR>
          <TD vAlign=top width="100%">
            ...
            border=0>
              ...
              <TR vAlign=top>
                <TD align=middle width=106 height=93><A 
                  href="http://localhost:8080/company/detailProduct.jsp?productID=4"><FONT 
                  color=#000000><IMG 
                  style="BORDER-LEFT-COLOR: #000000; BORDER-BOTTOM-COLOR: #000000; BORDER-TOP-COLOR: #000000; BORDER-RIGHT-COLOR: #000000" 
                  height=65 hspace=0 
                  src="image/d_r11_10_r1_c22.jpg" width=70 
                  align=center border=0></FONT></A></TD>
                <TD height=93>
                  <TABLE cellSpacing=1 cellPadding=4 width="100%"
                  bgColor=#cccccc border=0>
        ...
        <TR vAlign=bottom align=right>
          <TD width="100%" colSpan=3>&nbsp;&nbsp;&nbsp;&nbsp;<A 
            href="http://localhost:8080/company/showProductList.jsp?page=1">上一页</A>| 
            <A 
            href="http://localhost:8080/company/showProductList.jsp?page=2">下一页</A></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><LINK 
href="image/css.css" type=text/css rel=stylesheet>
